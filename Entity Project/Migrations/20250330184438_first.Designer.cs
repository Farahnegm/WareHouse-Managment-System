...
namespace Entity_Project.Migrations
{
    ...
    [Migration("20250330184438_first")]
    partial class first
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity_Project.Employee", b =>
                {
            ...
            modelBuilder.Entity("Entity_Project.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("Entity_Project.Entities.Item", b =>
                {
            ...
            modelBuilder.Entity("Entity_Project.Entities.ItemWarehouse", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity_Project.Entities.ReleaseOrder", b =>
                {
            ...
            modelBuilder.Entity("Entity_Project.Entities.ReleaseOrderItem", b =>
                {
                    b.Property<int>("ReleaseOrderID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity_Project.Entities.Supplier", b =>
                {
            ...
            modelBuilder.Entity("Entity_Project.Entities.SupplyOrder", b =>
                {
            ...
            modelBuilder.Entity("Entity_Project.Entities.SupplyOrderItem", b =>
                {
                    b.Property<int>("SupplyOrderID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity_Project.Entities.Warehouse", b =>
                {
                    b.Property<int>("WarehouseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity_Project.StockTransfer", b =>
                {
            ...
            modelBuilder.Entity("Entity_Project.StockTransferItem", b =>
                {
                    b.Property<int>("stockTransferID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity_Project.Entities.ItemWarehouse", b =>
                {
                    b.HasOne("Entity_Project.Entities.Item", "Item")
                        .WithMany("ItemWarehouses")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity_Project.Entities.Warehouse", "Warehouse")
                        .WithMany("ItemWarehouses")
            ...
            modelBuilder.Entity("Entity_Project.Entities.ReleaseOrder", b =>
                {
                    b.HasOne("Entity_Project.Entities.Supplier", "Supplier")
                        .WithMany("ReleaseOrders")
                        .HasForeignKey("SuppilerName")
                        .HasPrincipalKey("SupplierName")
                        .IsRequired();

                    b.HasOne("Entity_Project.Entities.Warehouse", null)
                        .WithMany("ReleaseOrders")
                        .HasForeignKey("WarehouseID");
            ...
            modelBuilder.Entity("Entity_Project.Entities.ReleaseOrderItem", b =>
                {
                    b.HasOne("Entity_Project.Entities.Item", null)
                        .WithMany("ReleasePermits")
                        .HasForeignKey("ItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity_Project.Entities.ReleaseOrder", "ReleaseOrder")
                        .WithMany("ReleaseOrderItems")
                        .HasForeignKey("ReleaseOrderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity_Project.Entities.ItemWarehouse", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("Entity_Project.Entities.SupplyOrder", b =>
                {
                    b.HasOne("Entity_Project.Entities.Supplier", null)
            ...
            modelBuilder.Entity("Entity_Project.Entities.SupplyOrderItem", b =>
                {
                    ...
                    b.HasOne("Entity_Project.Entities.SupplyOrder", "SupplyOrder")
            ...
            modelBuilder.Entity("Entity_Project.Entities.Warehouse", b =>
                {
                    b.HasOne("Entity_Project.Employee", "ResponsiblePerson")
                        .WithMany()
            ...
            modelBuilder.Entity("Entity_Project.StockTransfer", b =>
                {
                    b.HasOne("Entity_Project.Entities.Warehouse", "DestinationWarehouse")
                    ...
                    b.HasOne("Entity_Project.Entities.Warehouse", "SourceWarehouse")
            ...
            modelBuilder.Entity("Entity_Project.StockTransferItem", b =>
                {
                    ...
                    b.HasOne("Entity_Project.StockTransfer", "Transfer")
